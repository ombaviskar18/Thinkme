...
<div className='row' style={{ position: 'absolute', top: `230vh` }}>
  <div className='col' style={{ position: 'absolute', right: `40px`, width: "540px" }}>
    ...
    Read more
          ...
          <h2 style={{ position: 'absolute', top: '440vh', left: '50%', transform: `translate(-50%,-50%)` }}>ThinkMe AI is designed to push the boundaries of human-AI interaction, allowing users to explore creativity and productivity.</h2>            
